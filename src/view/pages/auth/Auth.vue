      ...
      >
        ...
        <div class="d-flex flex-row-fluid flex-column justify-content-between">
          ...
          <a href="#" class="flex-column-auto">
            <img src="media/logos/logo-nethesapp-white.png" class="h-75" />
          </a>
          <!--end: Aside header -->
          <!--begin: Aside content -->
          <div
          ...
          >
            ...
            <p class="font-weight-lighter text-white opacity-80">
              Tüm banka hesap hareketlerinizi otomatik olarak toplayıp tek
              platformda anlık ve dönemsel olarak sunar.
            </p>
          </div>
          <!--end: Aside content -->
